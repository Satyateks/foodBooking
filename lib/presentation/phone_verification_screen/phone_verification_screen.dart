...
class PhoneVerificationScreen extends StatelessWidget {
                          ...
                          child: RichText(
                              text: TextSpan(children: [
                                TextSpan(
                                    ...
                                    style: CustomTextStyles.bodyMediumff6a788a
                                        .copyWith(
                                            decoration:
                                                TextDecoration.underline)),
                                TextSpan(
                                    text: "Get a New one",
                                    style: CustomTextStyles.bodyMediumfff3739e
                                        .copyWith(
                                            decoration:
                                                TextDecoration.underline))
                              ]),
  ...
  /// Navigates to the phoneVerificationFilledScreen when the action is triggered.
  onTapVerify(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.phoneVerificationFilledScreen);
  }
}
